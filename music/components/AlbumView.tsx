...
// The album page's interactive body (issues #116, #129): the album's own
// generated cover blurred into a full-bleed backdrop (the TIDAL move),
// metadata with the quality badge, and the tracklist with the now-playing
// row lit. Clicking any row queues the whole album from that point.
//
